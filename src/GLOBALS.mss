...
_userTextStyleNames "Section;Subsection;Grgnum;Mükerrer;Editor Initials;Fasıl;Incipit;Usûl name;Darb text;Source;CMO Ref;Makâm;Usûl;Genre;Line break;Column break;Page break"
_userTextDirections "Ho;Performance instruction;Performance instruction (above);Verj"